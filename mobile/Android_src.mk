...
LOCAL_MODULE    := crispy-$(STATIC_LIB)

LOCAL_CFLAGS :=  -DENGINE_NAME=\"chocdoom\" -Wall -Wdeclaration-after-statement  -D_GNU_SOURCE=1 -D_REENTRANT -DHAVE_DIRENT_H -DCHOCOLATE
...
LOCAL_STATIC_LIBRARIES += static-crispy-opl static-crispy-textscreen static-crispy-pcsound SDL2_net logwritter
LOCAL_STATIC_LIBRARIES += static-crispy-$(STATIC_LIB) static-crispy-textscreen
